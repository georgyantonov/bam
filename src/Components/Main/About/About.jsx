        ...
        <div className="bam_info">
          ...
          <div className="employees">
            <div>
              ...
              <p className='tell'>Вы узнаете больше о настоящем БАМе: почувствуете дух того времени через истории людей, воспоминания, дневники, мемуары, очерки, фотографии.<br/>
